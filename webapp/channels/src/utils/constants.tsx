...
export const AboutLinks = {
    TERMS_OF_SERVICE: 'https://dharunashokkumar.com/konnect/terms-of-use/',
    PRIVACY_POLICY: 'https://dharunashokkumar.com/konnect/privacy-policy/',
};

export const CloudLinks = {
    BILLING_DOCS: 'https://docs.dharunashokkumar.com/konnect/cloud-billing',
    PRICING: 'https://dharunashokkumar.com/konnect/pricing/',
    PRORATED_PAYMENT: 'https://dharunashokkumar.com/konnect/mattermost-cloud-prorate-documentation',
    DEPLOYMENT_OPTIONS: 'https://dharunashokkumar.com/deploy/',
    DOWNLOAD_UPDATE: 'https://dharunashokkumar.com/deploy/',
    CLOUD_SIGNUP_PAGE: 'https://dharunashokkumar.com/sign-up/',
    SELF_HOSTED_SIGNUP: 'https://customers.dharunashokkumar.com/signup',
    DELINQUENCY_DOCS: 'https://docs.dharunashokkumar.com/about/cloud-subscriptions.html#failed-or-late-payments',
    SELF_HOSTED_PRICING: 'https://dharunashokkumar.com/konnect/pricing/#self-hosted',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://dharunashokkumar.com/konnect/how-self-hosted-billing-works',
    SELF_HOSTED_BILLING: 'https://dharunashokkumar.com/konnect/self-hosted-billing',
    TERMS_AND_CONDITIONS: 'https://dharunashokkumar.com/enterprise-edition-terms/',
    SECURITY_UPDATES: 'https://dharunashokkumar.com/security-updates/',
    DOWNLOAD: 'https://dharunashokkumar.com/konnect/k25km-app',
    NEWSLETTER_UNSUBSCRIBE_LINK: 'https://forms.dharunashokkumar.com/UnsubscribePage.html',
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS: 'https://docs.dharunashokkumar.com/welcome/about-teams.html#team-url',
    ADVANCED_LOGGING: 'https://dharunashokkumar.com/konnect/advanced-logging',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://dharunashokkumar.com/konnect/configure-document-content-search',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://dharunashokkumar.com/konnect/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://dharunashokkumar.com/konnect/configure-override-saml-bind-data-with-ldap',
    COMPILANCE_EXPORT: 'https://dharunashokkumar.com/konnect/compliance-export',
    COMPILANCE_MONITORING: 'https://dharunashokkumar.com/konnect/compliance-monitoring',
    DATA_RETENTION_POLICY: 'https://dharunashokkumar.com/konnect/data-retention-policy',
    DEFAULT_LDAP_GROUP_SYNC: 'https://dharunashokkumar.com/konnect/default-ldap-group-sync',
    DESKTOP_MANAGED_RESOURCES: 'https://dharunashokkumar.com/konnect/desktop-managed-resources',
    ELASTICSEARCH: 'https://dharunashokkumar.com/konnect/setup-elasticsearch',
    ENABLE_HARDENED_MODE: 'https://dharunashokkumar.com/konnect/enable-hardened-mode',
    FORMAT_MESSAGES: 'https://dharunashokkumar.com/konnect/format-messages',
    FILE_STORAGE: 'https://dharunashokkumar.com/konnect/configure-file-storage',
    GUEST_ACCOUNTS: 'https://docs.dharunashokkumar.com/onboard/guest-accounts.html',
    HIGH_AVAILABILITY_CLUSTER: 'https://dharunashokkumar.com/konnect/high-availability-cluster',
    IN_PRODUCT_NOTICES: 'https://dharunashokkumar.com/konnect/in-product-notices',
    MULTI_FACTOR_AUTH: 'https://dharunashokkumar.com/konnect/multi-factor-authentication',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://dharunashokkumar.com/konnect/advanced-permissions',
    ONBOARD_LDAP: 'https://dharunashokkumar.com/konnect/setup-ldap',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://dharunashokkumar.com/konnect/configure-session-lengths',
    SETUP_IMAGE_PROXY: 'https://dharunashokkumar.com/konnect/setup-image-proxy',
    SETUP_LDAP: 'https://dharunashokkumar.com/konnect/setup-ldap',
    SETUP_PERFORMANCE_MONITORING: 'https://dharunashokkumar.com/konnect/setup-performance-monitoring',
    SETUP_PUSH_NOTIFICATIONS: 'https://dharunashokkumar.com/konnect/setup-push-notifications',
    SETUP_SAML: 'https://docs.dharunashokkumar.com/konnect/setup-saml',
    SHARE_LINKS_TO_MESSAGES: 'https://dharunashokkumar.com/konnect/share-links-to-messages',
    SITE_URL: 'https://dharunashokkumar.com/konnect/configure-site-url',
    SSL_CERTIFICATE: 'https://dharunashokkumar.com/konnect/setup-ssl-client-certificate',
    TRUE_UP_REVIEW: 'https://dharunashokkumar.com/konnect/true-up-documentation',
    TRUSTED_CONNECTION: 'https://dharunashokkumar.com/konnect/default-allow-untrusted-internal-connections',
    UPGRADE_SERVER: 'https://dharunashokkumar.com/konnect/upgrade-mattermost',
};

export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://dharunashokkumar.com/konnect/custom-slash-commands',
    ENABLE_OAUTH2: 'https://dharunashokkumar.com/konnect/enable-oauth',
    INCOMING_WEBHOOKS: 'https://dharunashokkumar.com/konnect/incoming-webhooks',
    OUTGOING_WEBHOOKS: 'https://dharunashokkumar.com/konnect/outgoing-webhooks',
    INTERACTIVE_MESSAGES: 'https://dharunashokkumar.com/konnect/interactive-messages',
    INTERACTIVE_DIALOGS: 'https://dharunashokkumar.com/konnect/interactive-dialogs',
    PERSONAL_ACCESS_TOKENS: 'https://dharunashokkumar.com/konnect/personal-access-tokens',
    PLUGIN_SIGNING: 'https://dharunashokkumar.com/konnect/sign-plugins',
    PLUGINS: 'https://dharunashokkumar.com/konnect/plugins',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://dharunashokkumar.com/konnect/setup-custom-slash-commands',
    SETUP_INCOMING_WEBHOOKS: 'https://dharunashokkumar.com/konnect/setup-incoming-webhooks',
    SETUP_OAUTH2: 'https://dharunashokkumar.com/konnect/setup-oauth-2.0',
    SETUP_OUTGOING_WEBHOOKS: 'https://dharunashokkumar.com/konnect/setup-outgoing-webhooks',
};

export const LicenseLinks = {
    CONTACT_SALES: 'https://dharunashokkumar.com/contact-sales/',
    ENTRY_LIMITS_INFO: 'https://dharunashokkumar.com/konnect/dharunashokkumar-entry-limits',
    TRIAL_INFO_LINK: 'https://dharunashokkumar.com/trial',
    EMBARGOED_COUNTRIES: 'https://dharunashokkumar.com/konnect/limitations-for-embargoed-countries',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT: 'https://dharunashokkumar.com/konnect/software-and-services-license-agreement',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT_TEXT: 'Software Services and License Agreement',
    UNSUPPORTED: 'https://dharunashokkumar.com/pricing/',
    UNSUPPORTED_UPGRADE_LINK: 'https://docs.dharunashokkumar.com/administration-guide/upgrade/enterprise-install-upgrade.html#upgrading-to-enterprise-edition-from-mattermost-team-edition',
};

export const MattermostLink = 'https://dharunashokkumar.com/';
